// -*- C++ -*-
//
// Package:    CMSDAS_MET/CMSDAS_MET_Analysis
// Class:      CMSDAS_MET_Analysis
//
/**\class CMSDAS_MET_Analysis CMSDAS_MET_Analysis.cc CMSDAS_MET/CMSDAS_MET_Analysis/plugins/CMSDAS_MET_Analysis.cc
...
class CMSDAS_MET_Analysis : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit CMSDAS_MET_Analysis(const edm::ParameterSet&);
      ~CMSDAS_MET_Analysis();
...
//
CMSDAS_MET_Analysis::CMSDAS_MET_Analysis(const edm::ParameterSet& iConfig)
 :
...
CMSDAS_MET_Analysis::~CMSDAS_MET_Analysis()
{
...
void
CMSDAS_MET_Analysis::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
CMSDAS_MET_Analysis::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void
CMSDAS_MET_Analysis::endJob()
{
  file->cd();
  tree->Write();
  file->Write();
...
void
CMSDAS_MET_Analysis::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CMSDAS_MET_Analysis);
